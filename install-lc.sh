...
echo "Now you can run the SIMPLE GRID installer for LC"
# puppet apply --modulepath /etc/puppetlabs/code/environments/production/modules -e "class {'simple_grid::install::lightweight_component::simple_installer':puppet_master => 'dev-cm-01.cern.ch'}"
